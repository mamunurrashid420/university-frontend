...
export default function BenefitsSection() {
  ...
  return (
    <section className="w-full py-12 md:py-20 lg:py-[100px] px-4 md:px-6 lg:px-[316px] bg-[#E7F0FD] relative overflow-hidden">
      {/* Background Ellipse */}
        ...
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          <div className="flex flex-col lg:flex-row">
            ...
            {leftPanel?.type === 'image' ? (
              <div className="w-full lg:w-[384px] h-[300px] md:h-[400px] lg:h-[504px] relative">
                <Image
              ...
              <div className="w-full lg:w-[384px] h-[300px] md:h-[400px] lg:h-[504px] relative bg-[#F2F5FD] flex flex-col justify-between p-6 md:p-8">
                {/* Top Content */}
                <div className="flex flex-col gap-4">
                  {/* Title with curved underline */}
                  <div>
                    <h2 className="text-xl md:text-2xl font-bold text-[#464646] mb-2">
                  ...
                  {/* Button */}
                  <button className="w-fit px-6 py-3 bg-[#FF8835] text-white font-bold rounded-lg hover:bg-[#e6772a] transition-colors mt-2">
            ...
            <div className="flex-1">
              ...
              <div className="flex flex-wrap border-b border-gray-200">
                {tabs.map((tab) => (
                  <button
                    ...
                    className={`flex-1 min-w-[120px] px-4 md:px-8 py-3 md:py-5 text-sm md:text-lg font-bold transition-colors ${
                      activeTab === tab.id
              ...
              {/* Tab Content */}
              <div className="p-6 md:p-[59px] bg-white">
                <div className="w-full">
                  {/* Content */}
                  <div className="w-full">
                    <h3 className="text-lg md:text-[22px] leading-tight md:leading-[26px] font-bold text-[#0A418F] mb-4 md:mb-6">
                      {activeContent?.title}
                    </h3>
                    {activeContent?.paragraphs.map((para, index) => (
                      <p
                        key={index}
                        className="text-base leading-[27px] text-[#8C8C8C] mb-4"
                      >
                        {para}
                      </p>
                    ))}
